...
Label(text="you have got 30 sec to talk about something  for enrollment process",font="arial 10",background="#4a4a4a",fg="white").pack()
Label(text="click record once you are ready with it",font="arial 10",background="#4a4a4a",fg="white").pack()
#button
